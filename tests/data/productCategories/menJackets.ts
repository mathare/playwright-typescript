  ...
  Climate: [
    {
      title: 'All-Weather',
      count: 5,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=201`,
    },
    {
      title: 'Cold',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=202`,
    },
    {
      title: 'Cool',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=203`,
    },
    {
      title: 'Indoor',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=204`,
    },
    {
      title: 'Mild',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=205`,
    },
    {
      title: 'Rainy',
      count: 5,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=206`,
    },
    {
      title: 'Spring',
      count: 10,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=207`,
    },
    {
      title: 'Warm',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=208`,
    },
    {
      title: 'Windy',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=209`,
    },
    {
      title: 'Wintry',
      count: 3,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?climate=210`,
    },
  ],
  Color: [
  ...
  EcoCollection: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?eco_collection=1`,
    },
    {
      title: 'No',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?eco-collection=0`,
    },
  ],
  ErinRecommends: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?erin_recommends=1`,
    },
    {
      title: 'No',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?erin_recommends=0`,
    },
  ],
  Material: [
    {
    ...
    },
    {
      title: 'Cotton',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=33`,
    },
    {
      title: 'Fleece',
      count: 5,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=144`,
    },
    {
      title: 'Hemp',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=145`,
    },
    {
      title: 'LumaTech™',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=147`,
    },
    {
      title: 'Lycra®',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=148`,
    },
    {
      title: 'Nylon',
      count: 5,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=37`,
    },
    {
      title: 'Polyester',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=38`,
    },
    {
      title: 'Spandex',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=150`,
    },
    {
      title: 'Wool',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?material=158`,
    },
  ],
  New: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?new=1`,
    },
    {
      title: 'No',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?new=0`,
    },
  ],
  Pattern: [
    {
      title: 'Solid',
      count: 11,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?pattern=196`,
    },
  ],
  PerformanceFabric: [
    {
      title: 'Yes',
      count: 3,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?performance_fabric=1`,
    },
    {
      title: 'No',
      count: 8,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?performance_fabric=0`,
    },
  ],
  Price: [
    {
      title: '$40.00 - $49.99',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?price=40-50`,
    },
    {
      title: '$50.00 - $59.99',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?price=50-60`,
    },
    {
      title: '$60.00 - $69.99',
      count: 3,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?price=60-70`,
    },
    {
      title: '$70.00 - $79.99',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?price=70-80`,
    },
    {
      title: '$80.00 and above',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?price=80-`,
    },
  ],
  Sale: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?sale=1`,
    },
    {
      title: 'No',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.TopsSubMenu.Jackets}?sale=0`,
    },
  ],
};
