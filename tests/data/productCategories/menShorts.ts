  ...
  Climate: [
    {
      title: 'All-Weather',
      count: 6,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=201`,
    },
    {
      title: 'Indoor',
      count: 11,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=204`,
    },
    {
      title: 'Mild',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=205`,
    },
    {
      title: 'Spring',
      count: 5,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=207`,
    },
    {
      title: 'Warm',
      count: 10,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=208`,
    },
    {
      title: 'Hot',
      count: 8,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?climate=211`,
    },
  ],
  Color: [
  ...
  EcoCollection: [
    {
      title: 'No',
      count: 12,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?eco-collection=0`,
    },
  ],
  ErinRecommends: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?erin_recommends=1`,
    },
    {
      title: 'No',
      count: 10,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?erin_recommends=0`,
    },
  ],
  Material: [
    {
    ...
    },
    {
      title: 'Cotton',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=33`,
    },
    {
      title: 'LumaTech™',
      count: 3,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=147`,
    },
    {
      title: 'Mesh',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=36`,
    },
    {
      title: 'Lycra®',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=148`,
    },
    {
      title: 'Nylon',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=37`,
    },
    {
      title: 'Polyester',
      count: 8,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=38`,
    },
    {
      title: 'Rayon',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=39`,
    },
    {
      title: 'Spandex',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=150`,
    },
    {
      title: 'CoolTech™',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=155`,
    },
    {
      title: 'Linen',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=157`,
    },
    {
      title: 'Wool',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?material=158`,
    },
  ],
  New: [
    {
      title: 'Yes',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?new=1`,
    },
    {
      title: 'No',
      count: 10,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?new=0`,
    },
  ],
  Pattern: [
    {
      title: 'Solid',
      count: 12,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?pattern=196`,
    },
    {
      title: 'Striped',
      count: 2,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?pattern=198`,
    },
  ],
  PerformanceFabric: [
    {
      title: 'Yes',
      count: 4,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?performance_fabric=1`,
    },
    {
      title: 'No',
      count: 8,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?performance_fabric=0`,
    },
  ],
  Price: [
    {
    ...
    {
      title: '$40.00 and above',
      count: 1,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?price=40-`,
    },
  ],
  Sale: [
    {
      title: 'Yes',
      count: 3,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?sale=1`,
    },
    {
      title: 'No',
      count: 9,
      link: `${HeaderLinks.Topnav.MenSubMenu.BottomsSubMenu.Shorts}?sale=0`,
    },
  ],
};
